...
class BenchMovement(models.Model):
    ...
    reverse = models.BooleanField()
    board = models.IntegerField(blank=True, default=0)
...
class UpperAccessoryMovement(models.Model):
    ...
    pushups = models.CharField(max_length=60, blank=True)
...
class LowerAccessoryMovement(models.Model):
    ...
    kb_swings = models.CharField(max_length=60, blank=True)
    trapbar_deadlift = models.CharField(max_length=60, blank=True)
